...
// The Joe's Automotive class creates the gui for the Joes Automotive

public class JoesAutomotiveGUI extends JFrame{ // must extend JFrame to allows program to run in JFrame window
