...
public class itemLauncher {
	...
	public static void main(String[] args) throws NotValidAmount, NotValidUnits {
		...
		// this is the group of arrays with their selected values 
				...
				for (int i = 0; i < items.length; i++){
					...
					if(items[i].getUnits() < 0 || items[i].getPrice() < 0)
						throw new NotValidUnits();
					// this throws the exception ;
				
					// this if statement will not alow lower than a 0
